<ul id="menu">
  <li id="dashboard"><a href="<?php echo $home; ?>"><i class="fa fa-dashboard fa-fw"></i> <span><?php echo $text_dashboard; ?></span></a></li>
    <li><a href="<?php echo $googlemap; ?>"><?php echo $text_googlemap; ?></a></li>
    ...
    <ul>
      ...
      <li><a class="parent"><?php echo $text_localisation; ?></a>
        <ul>
          ...
          <li><a class="parent"><?php echo $text_page; ?></a>
            <ul>
                <li><a href="<?php echo $page; ?>"><?php echo $text_page; ?></a></li>
                <li><a href="<?php echo $upload_description; ?>"><?php echo $text_upload_description; ?></a></li>
            </ul>
          </li>
