            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                      <a href="<?php echo $manufacturer['edit_general']; ?>" data-toggle="tooltip" title="<?php echo $button_edit_general; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      <a href="<?php echo $manufacturer['edit_description']; ?>" data-toggle="tooltip" title="<?php echo $button_edit_description; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
