...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['text_upload_description'] = $this->language->get('text_upload_description');
		$data['page'] = $this->url->link('localisation/page', 'token=' . $this->session->data['token'], 'SSL');
        $data['upload_description'] = $this->url->link('localisation/upload_description', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['text_googlemap'] = $this->language->get('text_googlemap');
        $data['googlemap'] = $this->url->link('dashboard/googlemap', 'token=' . $this->session->data['token'], 'SSL');
