...
class ControllerCatalogManufacturer extends Controller {
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->model_catalog_manufacturer->edit_manufacturer_general($this->request->get['manufacturer_id'],$this->request->post);
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('catalog/manufacturer/edit', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['manufacturers'][] = array(
				...
				'edit_general'     => $this->url->link('catalog/manufacturer/edit', 'token=' . $this->session->data['token'] . '&manufacturer_id=' . $result['manufacturer_id'] . $url, 'SSL') ,
                'edit_description' => $this->url->link('catalog/manufacturer_description', 'token=' . $this->session->data['token'] . '&manufacturer_id=' . $result['manufacturer_id'] . $url, 'SSL')
			);
		}
		...
		$data['button_edit_description']    = $this->language->get('button_edit_description');
        $data['button_edit_general']        = $this->language->get('button_edit_general');
	...
	protected function getForm() {
		...
		if (isset($this->request->get['manufacturer_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$manufacturer_info = $this->model_catalog_manufacturer->get_manufacturer_general($this->request->get['manufacturer_id'],1);
		}
        else{
        ...
        $data['action'] = $this->url->link('catalog/manufacturer/edit', 'token=' . $this->session->data['token'] . '&manufacturer_id=' . $data['manufacturer_id'] . $url, 'SSL');
        ...
        if (isset($this->request->post['location'])) {
            ...
            $data['location'] = $manufacturer_info['location'];
        } else {
            $data['location'] = '';
        }
        ...
        if (isset($this->request->post['short_name'])) {
            ...
            $data['short_name'] = $manufacturer_info['short_name'];
        } else {
            $data['short_name'] = '';
        }
        ...
        if (isset($this->request->post['phone'])) {
            ...
            $data['phone'] = $manufacturer_info['phone'];
        } else {
            $data['phone'] = '';
        }
