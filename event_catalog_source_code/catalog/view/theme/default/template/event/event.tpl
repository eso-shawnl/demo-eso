    ...
    <div class="row">
        ...
        <div id="content" class="<?php echo $class; ?>">
            ...
            <div class="row">
                ...
                <div class="<?php echo $class; ?>">
                    ...
                    <ul class="thumbnails">
                        ...
                        <li class="image-additional"><a class="thumbnail" href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" data-something="something<?php echo $i?>" data-another-thing="anotherthing<?php echo $i?>">
            ...
            <div class="row">
                ...
                <div class="<?php echo $class; ?>">
                    <span ><strong><?php echo $text_view_number.$view_number ?></strong></span>
                </div>
            </div>
